...
const API_BASE_URL = "http://localhost:5000/api/cold-leads";
...
const ColdLead = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (editId) {
        const response = await axios.put(`${API_BASE_URL}/${editId}`, formData);
      ...
      const backendMessage =
        error?.response?.data?.message || "Something went wrong while saving data.";
  ...
  const handleDelete = async (id) => {
    const confirmDelete = window.confirm("Are you sure you want to delete this cold lead?");
          ...
          <div className="ColdLead__formCard">
            <div className="ColdLead__formHeader">
              ...
              <p className="ColdLead__subtitle">
                Add enquiry details and manage your preschool lead records easily.
              </p>
            </div>

            {errorMessage && (
              <div className="ColdLead__errorMessage">
                {errorMessage}
              </div>
            )}
                  ...
                  {tableLoading ? (
                    ...
                    coldLeadData.map((lead, index) => (
                      <tr key={lead._id}>
                        ...
                        <td className="ColdLead__messageCell">{lead.message}</td>
                        <td>
